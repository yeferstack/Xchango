...
export class IconoComponent {
  ...
  private dibujos: Record<string, string> = {
    ...
    calendar_month: '<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18"/><path d="M8 3v4M16 3v4"/>',
    call: '<path d="M6 3h4l2 5-3 2a12 12 0 0 0 5 5l2-3 5 2v4a2 2 0 0 1-2 2A16 16 0 0 1 4 5a2 2 0 0 1 2-2z"/>',
    lock: '<rect x="5" y="10" width="14" height="10" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3"/>',
    person_add: '<circle cx="9" cy="8" r="4"/><path d="M2 21a7 7 0 0 1 14 0"/><path d="M19 8v6M16 11h6"/>',
    visibility_off: '<path d="M4 4l16 16"/><path d="M9.9 5.2A9.9 9.9 0 0 1 12 5c6 0 10 7 10 7a17 17 0 0 1-3.3 4"/><path d="M6.3 7.6A17 17 0 0 0 2 12s4 7 10 7a9.7 9.7 0 0 0 4.2-.9"/>',
    upload_file: '<path d="M14 3H6v18h12V7z"/><path d="M14 3v4h4"/><path d="M12 17v-6"/><path d="m9.5 13.5 2.5-2.5 2.5 2.5"/>',
    fact_check: '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 9h6M7 13h4"/><path d="m15.5 14.5 1.5 1.5 3-3"/>',
    do_not_disturb: '<circle cx="12" cy="12" r="9"/><path d="M6 6l12 12"/>',
    logout: '<path d="M14 4H6v16h8"/><path d="M18 12H10"/><path d="m15 9 3 3-3 3"/>',
  };

  /** Devuelve el trazo del icono pedido (o un punto si no existe), ya marcado
   *  como HTML seguro: sin esto, Angular borra las etiquetas SVG del binding
   *  [innerHTML] y el ícono queda en blanco. */
  get trazo(): SafeHtml {
    const svg = this.dibujos[this.nombre] || '<circle cx="12" cy="12" r="2"/>';
